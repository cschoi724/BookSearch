...
/// Since BooksFeature is a static library, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "Books_BooksFeature"
        ...
        fatalError("unable to find bundle named Books_BooksFeature")
    }()
}
// MARK: - Objective-C Bundle Accessor
@objc
public class BooksFeatureResources: NSObject {
